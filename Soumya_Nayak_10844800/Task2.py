...
prompt = ChatPromptTemplate.from_messages([
    ...
    ("system", "You are a knowledgeable business analyst."),
...
agent1_query = (
    ...
    f"Provide an overview of the company {company_name}. "
...
Provide a short insight suitable for a business decision-maker.
